...
public class C01_OgrenciMapKullanma {
    ...
    //103 numarali ogrencinin soyismini yazdirin
     ...
     //   {101={sinif=10, sube=H, soyisim=Can, bolum=MF, isim=Ali},
        ...
        System.out.println(ogrenciNestedMap.get(103));//{sinif=12, sube=H, soyisim=Cem, bolum=TM, isim=Ali}
        System.out.println(ogrenciNestedMap.get(103).get("soyisim"));//Cem

        //101 numrali ogrencinin bolumunu yazdirin

        System.out.println(ogrenciNestedMap.get(101).get("bolum")); //MF

       //102 numaralı ogrencinin subesini K yapın

       ogrenciNestedMap.get(102).replace("sube","K");

        System.out.println(ogrenciNestedMap);//102={sinif=11, sube=K, soyisim=Cem, bolum=Soz, isim=Veli}

        //101 numralı ogrencinin bolumunu TM yapın

        ogrenciNestedMap.get(101).put("bolum", "TM");

        System.out.println(ogrenciNestedMap);//101=sinif=10, sube=H, soyisim=Can, bolum=TM
