...
//sayilari birbirine bölüp, işlem sonucunu ondalıklı olarak yazdırn
        ...
        System.out.println("Verdiğiniz tam sayılıların bolum sonucu : "+ (sayi1/sayi2) );
        //java da bolumun tamSayı kısmı alınır...
        double sayi3;

        sayi3=(double)sayi1/sayi2;
        System.out.println("Verdiğiniz sayılıların bolum sonucu : "+sayi3);

//NOT Bir tamsayıyı 10 a bölersek birler basamagındaki rakamdan kurtluruz...
