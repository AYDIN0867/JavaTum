...
public class C01_TreeMapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        //constructoru treemap olduğu için bize harf sırasına göre verdi



        /*
Constructor TreeMap secilmis olsa da
Data turu olarak Map secildigi icin map2 BUTUN MAP'lerle ortak method isimlerine sahiptir


TreeMap class 'ina sonradan eklenen
ve sadece TreeMaplerin  sahip oldugu methodlar  map2 de gorulmez
        ...
        Constructor ve data turu TreeMap secildigi için
        TreeMap e eklenen ve parent i olan Map de olamyan pekcok ozelligi kullanabiliriz
         */
